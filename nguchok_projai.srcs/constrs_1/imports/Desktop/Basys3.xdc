...
# Switches
set_property PACKAGE_PIN V17 [get_ports {GAMEMODE}]					
...
#set_property PACKAGE_PIN V2 [get_ports {Bin[3]}]					
#	set_property IOSTANDARD LVCMOS33 [get_portsBinsw[8]}]
...
#	set_property IOSTANDARD LVCMOS33 [get_ports {ALU_control[3]}]
 

## LEDs
set_property PACKAGE_PIN U16 [get_ports {RESET_LED}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {RESET_LED}]
set_property PACKAGE_PIN E19 [get_ports {ENTER_LED}]					
...
#set_property PACKAGE_PIN V19 [get_ports {state[0]}]					
#	set_property IOSTANDARD LVCMOS33 [get_ports {state[0]}]
set_property PACKAGE_PIN W18 [get_ports {RIGHT_LED}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {RIGHT_LED}]
set_property PACKAGE_PIN U15 [get_ports {DOWN_LED}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {DOWN_LED}]
set_property PACKAGE_PIN U14 [get_ports {UP_LED}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {UP_LED}]
set_property PACKAGE_PIN V14 [get_ports {LEFT_LED}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {LEFT_LED}]
#set_property PACKAGE_PIN V13 [get_ports {ledM[8]}]					
#	set_property IOSTANDARD LVCMOS33 [get_ports {ledM[8]}]
#set_property PACKAGE_PIN V3 [get_ports {ledM[9]}]					
#	set_property IOSTANDARD LVCMOS33 [get_ports {ledM[9]}]
...
set_property PACKAGE_PIN U2 [get_ports {displaySegment[0]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {displaySegment[0]}]
set_property PACKAGE_PIN U4 [get_ports {displaySegment[1]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {displaySegment[1]}]
set_property PACKAGE_PIN V4 [get_ports {displaySegment[2]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {displaySegment[2]}]
set_property PACKAGE_PIN W4 [get_ports {displaySegment[3]}]					
...
##Sch name = JB9
set_property PACKAGE_PIN C15 [get_ports {RESET}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {RESET}]
##Sch name = JB10 
set_property PACKAGE_PIN C16 [get_ports {ENTER}]					
